...
SKILL_KEYWORDS: dict[str, list[str]] = {
    ...
    "Office Tools":     ["word", "excel", "powerpoint", "ms office", "microsoft office",
                         "office", "tin học văn phòng", "tin hoc van phong"],

    # Vietnamese-specific roles / soft skills
    "Giao tiếp":        [
        "giao tiếp tốt", "kỹ năng giao tiếp", "giao tiep", "communication",
        "communicate", "interpersonal", "thuyết trình", "trinh bay"
    ],
    "Quản lý dự án":    ["quản lý dự án", "project management", "pm", "pmp", "lập kế hoạch dự án"],
    "Làm việc nhóm":    [
        "làm việc nhóm", "lam viec nhom", "teamwork", "team work", "team player",
        "collaboration", "collaborate", "cross-functional", "cross functional",
        "phối hợp nhóm", "phoi hop nhom", "phối hợp", "hop tac"
    ],
    "Tư duy phân tích": [
        "tư duy phân tích", "tu duy phan tich", "analytical thinking",
